...
void Demo::Render() {
	...
	DrawKiri(this->depthmapShader);
	DrawKanan(this->depthmapShader);
	DrawAtas(this->depthmapShader);
	...
	glm::vec3 cameraPos = glm::vec3(5, 3, 3);
	...
	glActiveTexture(GL_TEXTURE1);
	glBindTexture(GL_TEXTURE_2D, depthMap);
	DrawKanan(this->shadowmapShader);
...
void Demo::DrawKiri(GLuint shader)
{
	UseShader(shader);
	glBindVertexArray(cubeVAO);
	glm::mat4 model;
...
void Demo::DrawKanan(GLuint shader)
{
	UseShader(shader);
	glBindVertexArray(cubeVAO2);
	glm::mat4 model;
...
void Demo::DrawAtas(GLuint shader)
{
	UseShader(shader);
	glBindVertexArray(cubeVAO3);
	glm::mat4 model;
...
int main(int argc, char** argv) {
	...
	app.Start("Erika - Shadow Mapping Demo", 800, 600, false, false);
}